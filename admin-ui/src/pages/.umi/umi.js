...
import findRoute, {
  getUrlQuery,
} from '/Users/zhangpengcheng/workspace/personal/admin-ui-js/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/Users/zhangpengcheng/workspace/personal/admin-ui-js',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
